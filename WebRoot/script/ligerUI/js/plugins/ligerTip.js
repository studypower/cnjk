...
(function ($)
{
    ...
    $.ligerui.controls.Tip.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _render: function ()
        {
            ...
            var corner="l-verify-tip-corner-left";
            if(p.corner){
            	corner="l-verify-tip-corner-"+p.corner;
            }
            var tip = $('<div class="l-verify-tip"><div class="'+corner+'"></div><div class="l-verify-tip-content"></div></div>');
            g.tip = tip;
            g.tip.attr("id", g.id);
            if (p.content)
            {
