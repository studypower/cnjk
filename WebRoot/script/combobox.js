(function( $ ) {
	$.widget( "custom.combobox", {
		_create: function() {
			if(this.element.attr("zj_class")!=null && this.element.attr("zj_class")!=""){
				this.wrapper = $( "<span>" ).addClass( this.element.attr("zj_class") ).addClass( "custom-combobox" ).insertAfter( this.element );
			} else{
		...
		_createShowAllButton: function() {
			...
			$( "<a>" ).attr( "tabIndex", -1 ).attr( "title", "Show All Items" ).appendTo( this.wrapper )
				.button({
					icons: {
