		...
		$("#dataGrid").jqGrid({
	        ...
	        colModel: [
	            {name: "name",width:200,sortable:false,align:"center",formatter:function(key,options,rowObject){
	            	...
	            	if(rowObject['canRk']!=null && rowObject['canRk']!="" && rowObject['canRk']!=0){
	            		html += "<font color='red'>";
	            ...
	            {name: "type",width:160,sortable:false,align:"center",formatter:function(key,options,rowObject){
	            	if(rowObject['isBlanklines'] || key==null){
	            		return "";
	            	}
	            	var html = "";
	            ...
	            {name: "",width:200,sortable:false,align:"center",formatter:function(key,options,rowObject){
                	...
                	if(rowObject['step']==6 && rowObject['status']==0){
