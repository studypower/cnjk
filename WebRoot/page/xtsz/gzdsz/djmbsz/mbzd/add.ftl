			...
			<div id="form_content">
				<div id="tabs">
					...
					<div id="main_content" style="overflow:auto;">
						<form id="form1" name="form1" action="${gzUrl('xtsz/gzdsz/djmbsz/mbzd/add.do')}" method="post">
							<table border="0" width="800" style="overflow: hidden;">
								...
								<tr>
									...
									<td>
										<input type="radio"  name="columnRequired" value="0" onClick="checkDisPlay()" checked/><span class="edit_lbl">是</span>
										<input type="radio"  name="columnRequired" value="1" onClick="checkDisPlay()" /><span class="edit_lbl">否</span>
									</td>
									<td>
								...
								<tr>
									<td colspan="4">
										<input type="hidden" id="tableId" name="tableId" value="${tableId?if_exists}" />
