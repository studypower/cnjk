			...
			<div id="form_content">
				<div id="tabs">
					...
					<div id="main_content" style="overflow:auto;">
						<form id="form1" name="form1" action="${gzUrl('xtsz/gzdsz/djmbsz/update.do')}" method="post">
							<table border="0" width="800" style="overflow: hidden;">
								<tr>
									...
									<td colspan="3">
										<input type="text" id="name" name="name" class="text ui-widget-content ui-corner-all" value="${payrollTableInfo.name}"/>
									</td>
								</tr>
								<tr>
									<td>
									...
									<td colspan="3">
										<textarea class="text ui-widget-content ui-corner-all" name="remark" id="remark" style="width: 494px;">${payrollTableInfo.remark}</textarea>
									</td>
								</tr>
								<tr>
									<td colspan="4">
										<input type="hidden" id="id" name="id" class="text ui-widget-content ui-corner-all" value="${payrollTableInfo.id}"/>
