...
<body>
	...
	<div class="osx-container">
		<div class="osx-modal-header">
			...
			<div class="osx-modal-title">您现在所在的位置：系统设置->数据字典->供应商证书类别设置</div>
		</div>
			...
			<div id="form_content">
				<div id="tabs">
					...
					<div id="add" style="overflow:auto;">
						<form id="form1" name="form1" action="${gzUrl('xtsz/sjzd/gyszslb/update.do')}" method="post">
							<table border="0" width="360" style="overflow: hidden;">
							   	<tr>
									<td>
										<label for="name" class="edit_lbl">供应商证书类别名称:</label>
									</td>
									<input type="hidden" id="id" name="id" class="text ui-widget-content ui-corner-all" value="${dataSupplierCertificateType.id}"/>
									<td colspan="3">
										<input type="text" id="name" name="name" class="text ui-widget-content ui-corner-all" value="${dataSupplierCertificateType.name}"/>
									</td>
								</tr>
								<tr>
									<td colspan="4">
