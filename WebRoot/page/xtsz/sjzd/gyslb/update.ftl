			...
			<div id="form_content">
				<div id="tabs">
					...
					<div id="add" style="overflow:auto;">
						<form id="form1" name="form1" action="${gzUrl('xtsz/sjzd/gyslb/update.do')}" method="post">
							<table border="0" width="330" style="overflow: hidden;">
							   	<tr>
									<td>
										<label for="name" class="edit_lbl">供应商类别名称:</label>
									</td>
									<input type="hidden" id="id" name="id" class="text ui-widget-content ui-corner-all" value="${dataSupplierType.id}"/>
									<td colspan="3">
										<input type="text" id="name" name="name" class="text ui-widget-content ui-corner-all" value="${dataSupplierType.name}"/>
									</td>
								</tr>
								<tr>
									<td colspan="4">
