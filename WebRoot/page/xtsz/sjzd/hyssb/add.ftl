...
<body>
	...
	<div class="osx-container">
		<div class="osx-modal-header">
			...
			<div class="osx-modal-title">您现在所在的位置：系统设置->数据字典->会议室设备设置</div>
		</div>
			...
			<div id="form_content">
				<div id="tabs">
					...
					<div id="add" style="overflow:auto;">
						<form id="form1" name="form1" action="${gzUrl('xtsz/sjzd/hyssb/add.do')}" method="post">
							<table border="0" width="310" style="overflow: hidden;">
							   <tr>
									<td>
										<label for="typeId" class="edit_lbl">会议室设备:</label>
									</td>
									<td>
										<input type="text" id="deviceName" name="deviceName" class="text ui-widget-content ui-corner-all"/>
									</td>
								</tr>
								<tr>
									<td colspan="4">
