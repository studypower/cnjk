			...
			<div id="form_content">
				<div id="tabs">
					...
					<div id="add" style="overflow:auto;">
						<form id="form1" name="form1" action="${gzUrl('xtsz/sjzd/hyssb/update.do')}" method="post">
							<table border="0" width="310" style="overflow: hidden;">
							   <input type="hidden" id="id" name="id" class="text ui-widget-content ui-corner-all" value="${meetingRoomDevice.id}"/>
							   <tr>
									<td>
										<label for="typeId" class="edit_lbl">所属设备:</label>
									</td>
									<td>
										<input type="text" id="deviceName" name="deviceName" class="text ui-widget-content ui-corner-all" value="${meetingRoomDevice.deviceName}"/>
									</td>
								</tr>
								<tr>
									<td colspan="4">
