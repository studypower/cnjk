			...
			<div id="form_content">
				<div id="tabs">
					...
					<div id="add" style="overflow:auto;">
						<form id="form1" name="form1" action="${gzUrl('xtsz/sjzd/sb/add.do')}" method="post">
							<table border="0" width="310" style="overflow: hidden;">
								...
								<tr>
									...
									<td>
										<input type="text" class="text ui-widget-content ui-corner-all" value="${dataDeviceType.name}" readonly/>
										<input type="hidden" id="typeId" name="typeId" class="text ui-widget-content ui-corner-all" value="${dataDeviceType.id}"/>
									</td>
								</tr>
								<tr>
									<td colspan="4">
