			...
			<div id="form_content">
				<div id="tabs">
					...
					<div id="add" style="overflow:auto;">
						<form id="form1" name="form1" action="${gzUrl('xtsz/sjzd/sbpp/add.do')}" method="post">
							<table border="0" width="310" style="overflow: hidden;">
								...
								<tr>
									...
									<td>
										<input type="text" class="text ui-widget-content ui-corner-all" value="${dataDevice.name}" readonly/>
										<input type="hidden" id="deviceId" name="deviceId" class="text ui-widget-content ui-corner-all" value="${dataDevice.id}"/>
									</td>
								</tr>
								<tr>
									<td colspan="4">
