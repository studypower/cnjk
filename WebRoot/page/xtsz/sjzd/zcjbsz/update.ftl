...
<body>
	...
	<div class="osx-container">
		<div class="osx-modal-header">
			...
			<div class="osx-modal-title">您现在所在的位置：系统设置->数据字典->职称级别设置</div>
		</div>
			...
			<div id="form_content">
				<div id="tabs">
					...
					<div id="add" style="overflow:auto;">
						<form id="form1" name="form1" action="${gzUrl('xtsz/sjzd/zcjbsz/update.do')}" method="post">
							<table border="0" width="310" style="overflow: hidden;">
							   <input type="hidden" id="id" name="id" class="text ui-widget-content ui-corner-all" value="${dataZcjbInfo.id}"/>
							   	<tr>
									<td>
										<label for="name" class="edit_lbl">职称名称:</label>
									</td>
									<td>
										<input type="text" id="name" name="name" class="text ui-widget-content ui-corner-all" value="${dataZcjbInfo.name}"/>
									</td>
								</tr>
								<tr>
									<td colspan="4">
