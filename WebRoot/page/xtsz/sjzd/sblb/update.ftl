			...
			<div id="form_content">
				<div id="tabs">
					...
					<div id="add" style="overflow:auto;">
						<form id="form1" name="form1" action="${gzUrl('xtsz/sjzd/sblb/update.do')}" method="post">
							<table border="0" width="310" style="overflow: hidden;">
							   <input type="hidden" id="id" name="id" class="text ui-widget-content ui-corner-all" value="${dataDeviceType.id}"/>
							   	<tr>
									<td>
										<label for="name" class="edit_lbl">设备类别名称:</label>
									</td>
									<td>
										<input type="text" id="name" name="name" class="text ui-widget-content ui-corner-all" value="${dataDeviceType.name}"/>
									</td>
								</tr>
								<tr>
									<td colspan="4">
