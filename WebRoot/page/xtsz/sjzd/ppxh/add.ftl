			...
			<div id="form_content">
				<div id="tabs">
					...
					<div id="add" style="overflow:auto;">
						<form id="form1" name="form1" action="${gzUrl('xtsz/sjzd/ppxh/add.do')}" method="post">
							<table border="0" width="310" style="overflow: hidden;">
							   <tr>
									...
									<td>
										<input type="text" class="text ui-widget-content ui-corner-all" value="${dataBrand.name}" readonly/>
										<input type="hidden" id="brandId" name="brandId" class="text ui-widget-content ui-corner-all" value="${dataBrand.id}"/>
									</td>
								</tr>
							   	<tr>
									<td>
