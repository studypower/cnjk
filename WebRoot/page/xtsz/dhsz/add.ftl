			...
			<div id="form_content">
				<div id="tabs">
					...
					<div id="add" style="overflow:auto;">
						<form id="form1" name="form1" action="${gzUrl('xtsz/dhsz/add.do')}" method="post">
							<table border="0" width="600" style="overflow: hidden;">
							  <#if parentMenuInfo?exists>
								...
								<tr>
									...
									<td colspan="3">
										<#if parentMenuInfo?exists>${parentMenuInfo.key?if_exists}_</#if><input type="text" class="text ui-widget-content ui-corner-all" name="key" id="key"/>
									</td>
								</tr>
								...
								<tr>
									...
									<td colspan="3">
										<input type="text" class="text ui-widget-content ui-corner-all" id="url" name="url"  style="width:400px;"/>
									</td>
								</tr>
