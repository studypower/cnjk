			...
			<div id="form_content">
				<div id="tabs">
					...
					<div id="userInfo" style="overflow:auto;">
						<form id="userForm" name="userForm" action="${gzUrl('xtsz/yhgl/update.do')}" method="post">
							<table border="0" width="800" style="overflow: hidden;">
								<tr>
									...
									<td colspan="3">
										<input type="text" id="name" name="name" class="text ui-widget-content ui-corner-all" value="${userInfo.name}"/>
									</td>
								</tr>
								<tr>
									<td>
								...
								<tr>
									...
									<td colspan="3">
										<select id="staffId" name="staffId" class="select01">
											<#if userInfo.staffId?exists && userInfo.staffId!=0>
											<option value="${userInfo.staffId}" selected>${userInfo.staffName}--${userInfo.departmentName?if_exists}</option>
											</#if>
								...
								<tr>
									<td colspan="4">
										<input type="hidden" id="id" name="id" class="input_01" value="${userInfo.id}" />
