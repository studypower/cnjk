			...
			<div id="form_content">
				<div id="tabs">
					...
					<div id="add" style="overflow:auto;">
						<form id="form1" name="form1" action="${gzUrl('xtsz/bmgl/add.do')}" method="post">
							<table border="0" width="320" style="overflow: hidden;">
							   ...
							   <#if baseId?exists && baseId!=0>
							   	<tr>
									...
									<td colspan="3">
										<input type="text"  class="text ui-widget-content ui-corner-all" value="${department.name?if_exists}" readOnly/>
									</td>
								</tr>
							    </#if>	
								<tr>
								...
								<tr>
									...
									<td colspan="3">
										<input type="checkbox" id="isKqsyShow" name="isKqsyShow" value="1" class="checkbox ui-widget-content ui-corner-all"/>
									</td>
								</tr>
								<tr>
									<td>
									...
									<td colspan="3">
										<input type="text" id="kqsyOrder" name="kqsyOrder" value="0" class="text ui-widget-content ui-corner-all" style="width:28px" disabled=disabled />
									</td>
								</tr>
								<tr>
									<td colspan="4">
