...
<div id="pageloading"></div> 
	<div class="osx-container">
		<div class="osx-modal-header">
			...
			<div class="osx-modal-title">您现在所在的位置：人员管理->基本信息->人事编号导入</div>
		</div>
			...
			<div id="form_content">
				<div id="tabs">
					...
					<div id="project" style="overflow:auto;">
						<form id="form1" name="form1" action="${gzUrl('rygl/jbxx/importIndexNum.do')}" enctype="multipart/form-data" method="post">
							<table border="0" width="850" style="overflow: hidden;">
								<tr>
									...
									<td>
										<input type="file" id="indexNumFile" name="indexNumFile" class="text ui-widget-content ui-corner-all" />
									</td>
								</tr>
								<tr>
									<td colspan="4">
										(注：目前上载文件格式只支持xls，即Office2003版文件)
									</td>
								</tr>
								<tr>
									<td colspan="4">
										<input type="button" id="save" value="上载文件" style="font-size: ;font-family: 'yakov_wryh';width: 120px;"/>
									</td>
								</tr>
							</table>
						</form>
