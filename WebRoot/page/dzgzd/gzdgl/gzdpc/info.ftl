					...
					<div id="main_content" style="overflow:auto;">
						<table border="0" width="800" style="overflow: hidden;">
							<tr>
								...
								<td colspan="3">
									<input type="text" id="name" name="name" class="text ui-widget-content ui-corner-all" value="${payrollBatch.name}"/>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td colspan="3">
					                <input type="text" id="name" name="name" class="text ui-widget-content ui-corner-all" value="${payrollBatch.table_name}"/>
								</td>
							</tr>
						</table>
					</div>
