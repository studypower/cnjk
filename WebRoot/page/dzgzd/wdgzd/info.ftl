					...
					<div id="main_content" style="overflow:auto;">
						<table border="0" width="650" style="overflow: hidden;">
							...
							<#elseif payrollColumnInfo.column_name!="release_status" && payrollColumnInfo.column_name!="id">
								...
								<td>
									<#if payrollColumnInfo.column_name!='staff_name' && payrollColumnInfo.column_name!='bz'>
									<input type="text" id="${payrollEntry.get(payrollColumnInfo.column_name)}" name="${payrollEntry.get(payrollColumnInfo.column_name)}" class="text ui-widget-content ui-corner-all" value="${payrollEntry.get(payrollColumnInfo.column_name)?string('0.00')}" readonly/>
									<#else>
