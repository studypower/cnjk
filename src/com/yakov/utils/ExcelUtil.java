...
public class ExcelUtil {  
    ...
    public static void main(String[] args) {  
        ...
        /*String sql = "from Publicrecord";  
        try {  
            List list = DBUtil.searchByHql(sql);  
            new ExcelUtil("E:\\11.xls").write(list);  
        } catch (Exception e) {  
    ...
    public ExcelUtil(String sfilepath) {  
    ...
    public void write() throws Exception {  
        ...
        workbook = Workbook.createWorkbook(new File(this.sfilepath), ws);  
    ...
    public void write(WritableSheet s1, List list) throws Exception {  
  
        for (int i = 0; i < list.size(); i++) {  
            Object obj = list.get(i);  
            Object[] objset = (Object[]) obj;  
            for (int j = 0; j < objset.length; j++) {  
                Label lr = new Label(j, i, objset[j] == null ? "" : objset[j]  
                        .toString());  
                s1.addCell(lr);  
            }  
        }  
    ...
    /*public void write(List list) throws Exception {  
        ...
        if (list.get(0) instanceof Object[]) {  
            ...
            for (int i = 0; i < list.size(); i++) {  
                ...
                if (ifields == 0)  
                    ifields = obj.getClass().getDeclaredFields().length;  
                String scontent = "";  
                filelds = obj.getClass().getDeclaredFields();  
                for (int j = 0; j < filelds.length; j++) {  
  
                    String spropertie = filelds[j].getName();  
                    Object[] args = new Object[0];  
  
                    try {  
                        scontent = ReflectUtil.invokeMethod(obj, "get"  
                                + spropertie.substring(0, 1).toUpperCase()  
                                + spropertie.substring(1), args)  
                                + "";  
  
                    } catch (Exception e) {  
                        e.printStackTrace();  
                    }  
                    Label lr = new Label(j, i + 1, scontent);  
                    s1.addCell(lr);  
                }  
            }  
            for (int i = 0; i < ifields; i++) {  
                Label lr = new Label(i, 0, filelds[i].getName());  
                s1.addCell(lr);  
            }  
        }  
        ...
        workbook.setColourRGB(Colour.LIME, 0xff, 0, 0);  
        // Add a named range to the workbook  
        workbook.addNameArea("namedrange", s1, 1, 11, 5, 14);  
        workbook.write();  
        workbook.close();  
    }  */
    ...
    private void writeNumberFormatSheet(WritableSheet s) throws WriteException {  
        ...
        s.addCell(l);  
        NumberFormat poundCurrency = new NumberFormat(  
                NumberFormat.CURRENCY_POUND + " #,###.00",  
        ...
        s.addCell(l);  
        NumberFormat euroPrefixCurrency = new NumberFormat(  
                NumberFormat.CURRENCY_EURO_PREFIX + " #,###.00",  
                NumberFormat.COMPLEX_FORMAT);  
        WritableCellFormat euroPrefixFormat = new WritableCellFormat(  
                euroPrefixCurrency);  
        ...
        s.addCell(l);  
        NumberFormat euroSuffixCurrency = new NumberFormat("#,###.00"  
                + NumberFormat.CURRENCY_EURO_SUFFIX,  
                NumberFormat.COMPLEX_FORMAT);  
        WritableCellFormat euroSuffixFormat = new WritableCellFormat(  
                euroSuffixCurrency);  
        ...
        s.addCell(l);  
        NumberFormat dollarCurrency = new NumberFormat(  
        ...
        s.addCell(l);  
        NumberFormat japaneseYenCurrency = new NumberFormat(  
                NumberFormat.CURRENCY_JAPANESE_YEN + " #,###.00",  
                NumberFormat.COMPLEX_FORMAT);  
        WritableCellFormat japaneseYenFormat = new WritableCellFormat(  
                japaneseYenCurrency);  
        ...
        WritableCellFormat fraction1digitformat = new WritableCellFormat(  
                NumberFormats.FRACTION_ONE_DIGIT);  
        ...
        WritableCellFormat fraction2digitformat = new WritableCellFormat(  
                NumberFormats.FRACTION_TWO_DIGITS);  
        n = new Number(5, 33, 3.18279, fraction2digitformat);  
        s.addCell(n);  
  
        l = new Label(4, 34, "Three digit fraction format (improper)",  
                wrappedText);  
        s.addCell(l);  
  
        NumberFormat fraction3digit1 = new NumberFormat(  
                NumberFormat.FRACTION_THREE_DIGITS, NumberFormat.COMPLEX_FORMAT);  
        WritableCellFormat fraction3digitformat1 = new WritableCellFormat(  
                fraction3digit1);  
        n = new Number(5, 34, 3.18927, fraction3digitformat1);  
        s.addCell(n);  
  
        l = new Label(4, 35, "Three digit fraction format (proper)",  
                wrappedText);  
        s.addCell(l);  
  
        NumberFormat fraction3digit2 = new NumberFormat("# "  
                + NumberFormat.FRACTION_THREE_DIGITS,  
                NumberFormat.COMPLEX_FORMAT);  
        WritableCellFormat fraction3digitformat2 = new WritableCellFormat(  
                fraction3digit2);  
    ...
    private void writeLabelFormatSheet(WritableSheet s1) throws WriteException {  
        ...
        WritableFont arial12ptBold = new WritableFont(WritableFont.ARIAL, 12,  
                WritableFont.BOLD);  
        ...
        WritableFont arial10ptItalic = new WritableFont(WritableFont.ARIAL, 10,  
        ...
        WritableFont arial12ptItalic = new WritableFont(WritableFont.ARIAL, 12,  
                WritableFont.NO_BOLD, true);  
        ...
        WritableFont times12ptBold = new WritableFont(WritableFont.TIMES, 12,  
                WritableFont.BOLD);  
        ...
        WritableFont arial10ptDoubleUnderline = new WritableFont(  
                WritableFont.ARIAL, WritableFont.DEFAULT_POINT_SIZE,  
        ...
        WritableFont arial10ptSingleAcc = new WritableFont(WritableFont.ARIAL,  
                WritableFont.DEFAULT_POINT_SIZE, WritableFont.NO_BOLD, false,  
        ...
        WritableFont arial10ptDoubleAcc = new WritableFont(WritableFont.ARIAL,  
                WritableFont.DEFAULT_POINT_SIZE, WritableFont.NO_BOLD, false,  
        ...
        WritableFont subscript = new WritableFont(WritableFont.ARIAL,  
                WritableFont.DEFAULT_POINT_SIZE, WritableFont.NO_BOLD, false,  
                UnderlineStyle.NO_UNDERLINE, Colour.BLACK,  
        ...
        lr = new Label(4, 18, "Modified palette - was lime, now red",  
                limeFormat);  
        s1.addCell(lr);  
        ...
        lr = new Label(2, 20, "Blue background, yellow foreground",  
                yellowOnBlue);  
        s1.addCell(lr);  
        ...
        try {  
            ...
            wh = new WritableHyperlink(0, 34, 8, 34, "Link to another cell",  
                    s1, 0, 180, 1, 181);  
            s1.addHyperlink(wh);  
            ...
            url = new URL(  
                    "http://www.amazon.co.uk/exec/obidos/ASIN/0571058086"  
        ...
        /* 
         * l = new Label(5, 16, "merged cells"); s1.addCell(l); 
         *  
         * Label l5 = new Label(7, 17, "this label won't appear"); 
         * s1.addCell(l5); s1.mergeCells(5, 16, 8, 18); 
         *  
         * s1.mergeCells(5, 19, 6, 24); s1.mergeCells(6, 18, 10, 19); 
         */  
  
        WritableFont courier10ptFont = new WritableFont(WritableFont.COURIER,  
                10);  
        ...
        WritableFont.FontName wingdingsFont = WritableFont  
                .createFont("Wingdings 2");  
        ...
        cellFeatures.setComment("a very long cell comment indeed that won't "  
                ...
                + "larger comment box is used instead", 5, 6);  
        l.setCellFeatures(cellFeatures);  
        s1.addCell(l);  
        ...
        cellFeatures = new WritableCellFeatures();  
        cellFeatures  
                .setNumberValidation(4.5, WritableCellFeatures.GREATER_THAN);  
        b.setCellFeatures(cellFeatures);  
        s1.addCell(b);  
    }  
    ...
    private void writeBordersSheet(WritableSheet s) throws WriteException {  
        ...
        topBottomBlue.setBorder(Border.BOTTOM, BorderLineStyle.THIN,  
                Colour.BLUE);  
    ...
    private void writeFormulaSheet(WritableSheet ws) throws WriteException {  
        ...
        f = new Formula(2, 27,  
                "IF(COUNT(A1:A9,B1:B9)=0,\"\",COUNT(A1:A9,B1:B9))");  
        ws.addCell(f);  
        ...
        f = new Formula(2, 35,  
                "IF(((F1=\"Not Found\")*(F2=\"Not Found\")*(F3=\"\")*(F4=\"\")*(F5=\"\")),1,0)");  
        ws.addCell(f);  
        l = new Label(3, 35,  
                "IF(((F1=\"Not Found\")*(F2=\"Not Found\")*(F3=\"\")*(F4=\"\")*(F5=\"\")),1,0)");  
        ws.addCell(l);  
    ...
    private void writeImageSheet(WritableSheet ws) throws WriteException {  
        ...
        WritableImage wi = new WritableImage(0, 3, 5, 7, new File(  
                "resources/wealdanddownland.png"));  
        ws.addImage(wi);  
  
        l = new Label(0, 12, "Merchant Adventurers Hall, York");  
        ws.addCell(l);  
  
        wi = new WritableImage(5, 12, 4, 10, new File(  
                "resources/merchantadventurers.png"));  
        ws.addImage(wi);  
  
        // An unsupported file type  
  
        wi = new WritableImage(0, 60, 5, 5, new File("resources/uparrow.gif"));  
        ws.addImage(wi);  
